...
/** Source: 
   * https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Operators/this (this referencia o objeto (escopo) criado)
   ...
   * https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Operators/Spread_syntax (adiciona espalhamento de propriedades para objetos literais)
 * OBS: usei o .reduce que aprendemos na aula dia 04/01 para conseguir resolver esse requisito. Também tive ajuda, que me indicou ler sobre os assuntos dos links listados acima para resolução do requisito proposto. 
*/
const createMenu = (menuItems) => {
  const menu = {
    ...
    pay() {
      ...
      const total = this.consumption.reduce((accumulator, item) => accumulator + items[item], 0);
