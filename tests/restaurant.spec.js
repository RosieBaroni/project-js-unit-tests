...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  ...
  it('1 - Teste se createMenu() retorna um objeto', () => {
  ...
  it('2 - Teste se "objetoRetornado.fetchMenu()" retorna um objeto cujas chaves são somente "food" e "drink"', () => {
  ...
  it('3 - Teste se o menu passado pra função createMenu é identico ao menu recuperado pela função "objetoRetornado.fetchMenu"', () => {
    const menu = createMenu({ food: {}, drink: {} });
  ...
  it('4 - Teste se "objetoRetornado.consumption", após a criação do menu, retorna um array vazio.', () => {
    const menu = createMenu({ food: {}, drink: {} });
  ...
  it('5 - Teste se ao chamar uma função associada à chave `order` no objeto retornado, passando uma string como parâmetro (como `objetoRetornado.order("coxinha")`), tal string é adicionadaao array retornado em `objetoRetornado.consumption`', () => {
    const menu = createMenu({ food: {}, drink: {} });

    expect(menu.order("coxinha")).toEqual(menu.consumption["coxinha"]);
  });
  ...
  it('6 - Teste se ao adicionar três pedidos, dentre bebidas e comidas, o array `objetoRetornado.consumption` contém os itens pedidos', () => {
    const menu = createMenu({ food: {}, drink: {} });
  ...
  it('7 - Teste se a função `order` aceita que pedidos repetidos sejam acrescidos a consumption.', () => {
    const menu = createMenu({ food: {}, drink: {} });
    ...
    expect(menu.consumption).toEqual(["coxinha", "agua", "agua"]);
  });
  ...
  it('8 - Teste se, ao chamar `objetoRetornado.pay()`, retorna-se a soma dos preços de tudo que foi pedido, conforme registrado em `objetoRetornado.consumption`', () => {
    const menu = createMenu({
      food: { 'coxinha': 3.90, 'sanduiche': 9.90 },
      drinks: { 'agua': 3.90, 'cerveja': 6.90 }
    });
